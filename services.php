<?php
$servicos_web = file_exists('conteudo/servicos_web.txt') ? file_get_contents('conteudo/servicos_web.txt') : '';
$servicos_prog = file_exists('conteudo/servicos_prog.txt') ? file_get_contents('conteudo/servicos_prog.txt') : '';
...
<head>
  ...
  <title>Serviços | Meu site Portifólio</title>
...
<body>
  <header style="background:#0057d8;padding:18px 0;">
    <nav style="display:flex;align-items:center;justify-content:space-between;width:100%;padding:0 40px;" id="mainNav">
      ...
      <ul class="nav-menu" style="display:flex;gap:48px;list-style:none;margin:0;padding:0;" id="navMenu">
        <li><a href="about.php" style="color:#fff;text-decoration:none;font-weight:500;">Sobre Mim</a></li>
        ...
        <li><a href="services.php" class="active" style="color:#ffb400;text-decoration:none;font-weight:500;">Serviços</a></li>
  ...
  <h1><?php echo htmlspecialchars($titulo_servicos); ?></h1>
  <h2><?php echo htmlspecialchars($titulo_web); ?></h2>
  <?php echo $servicos_web; ?>
  <h2><?php echo htmlspecialchars($titulo_prog); ?></h2>
  <?php echo $servicos_prog; ?>
    </section>
  </main>
  <footer>
